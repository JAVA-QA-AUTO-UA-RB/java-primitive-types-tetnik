...
public class Main {
    public static void main(String[] args) {
        ...
        int favoriteNumber = 5 ; // Replace _ with the correct type and variable
        ...
        double decimalNumber = 2.2 ; // Replace _ with the correct type and variable
        ...
        char character = 'A' ; // Replace _ with the correct type and variable
        int asciiValue = 65 ; // Replace _ with the correct variable/type
